...
function buat_kode_supplier($init, $id_terakhir_tersimpan)
{
    // buat ID baru
    $kode = str_split($id_terakhir_tersimpan);
...
function buat_kode_produk($init, $id_terakhir_tersimpan)
{
    // buat ID baru
    $kode = str_split($id_terakhir_tersimpan);
