...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($sub_array['status'] == '0') {
        $sub_array['status'] = '<span class="label label-danger label-white middle">
                                                <i class="ace-icon fa fa-exclamation-triangle bigger-120"></i>
                                                ditolak
                                            </span>';
    }else if ($sub_array['status'] == '1') {
        $sub_array['status'] = '<span class="label label-success label-white middle">
                                                <i class="ace-icon fa fa-check-square bigger-120"></i>
                                                disetujui
                                            </span>';
    }else {
        $sub_array['status'] = '<span class="label label-info label-white middle">
