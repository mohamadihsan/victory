					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="white" id="id-company-text">&copy; PT. INDONESIA VICTORY GARMENT</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<h1 class="header black bigger">
												<i class="ace-icon fa fa-lock" style="color:#cd5c00"></i>
												Login
											</h1>
											...
											<form method="post" action="../action/login.php">
												...
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-35 pull-right" style="background-color:#cd5c00;color:#FFF">
